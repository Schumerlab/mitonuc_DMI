...
if(length(args)<5){
stop("usage is Rscript perform_pcor_admixture_mapping_v3_binomialtrait.R genotypes_file hybrid_index_file phenotypes_file focal_column_number name_tag")
}
...
out<-paste(infile,"_results_ppcor_v2",tag,sep="")
file.remove(out)
